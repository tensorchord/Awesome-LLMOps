...
| [OpenLIT](https://github.com/openlit/openlit/) | OpenLIT is an OpenTelemetry-native GenAI and LLM Application Observability tool. It provides valuable insights into usage, user engagement, and performance related metrics for LLMs, VectorDBs and Frameworks like Langchain. | ![GitHub Badge](https://img.shields.io/github/stars/openlit/openlit.svg?style=flat-square) |
